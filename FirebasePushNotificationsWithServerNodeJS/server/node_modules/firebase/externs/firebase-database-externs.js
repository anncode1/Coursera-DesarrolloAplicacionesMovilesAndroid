 ...
 * newMessageRef.set({ 'user_id': 'ada', 'text': 'Yabba Dabba Doo!' });
 ...
 * sibling child by priority order (or `null` if it is the firstchild).
 *
 ...
 * @return {!firebase.Promise<*>}
 */
firebase.database.Query.prototype.once = function(eventType, callback) {};
 ...
 * object by calling thie `val()` method. Alternatively, you can traverse into the
...
/**
 * Writes mulitple values this location when the client is disconnected (due to
